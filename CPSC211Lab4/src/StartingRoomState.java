...
public class StartingRoomState extends State {

    public StartingRoomState(Model model) {
        super(model);
    }

    @Override
    public String getDescription() {
        return "You are in a small room that feels like a prison cell. You are extremely thirsty. There is a bed, a television, and a bucket of water. There is a door to the north that seems to be cracked open.";
    }
